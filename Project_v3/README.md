...
* 第3步，进入 http://localhost:5000 查看结果

* 第4步，部署model
```python
mlflow  models serve -m /Users/tgl/PycharmProjects/MLporduction/Project_v3/mlruns/0/e59a5c037a2741819dfb6cc25b5ff1f9/artifacts/model -p 1234
```
* 第5步，调用服务进行预测
```python
